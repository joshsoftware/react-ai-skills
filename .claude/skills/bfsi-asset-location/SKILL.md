...
Every binary asset imported from React code lives under `src/assets/`. Two gates enforce this; this skill helps you place the file correctly _before_ the gates trigger so you don't waste a round-trip on a block message.
